...
$currentpassword="";
$newpassword="";
$fetchBdateSql="select bdate, address, email, phno from student where usn='$username'";
...
if(isset($_POST['password_change']))   {
    ...
    if($currentpassword!=$_SESSION['password']) {
        ...
        $passwordSql="UPDATE `student` SET `password`='$newpassword' where `usn`='$username'";
...
if(isset($_POST['edit_details'])){
    ...
    $updateDetailsSql="UPDATE `student` SET `name`='$name', `bdate`='$date', imgpath='$inputFileName', `phno`='$phno', `email`='$email', `address`='$address' where `usn`='$username'";
    if(mysql_query($updateDetailsSql)) {
        $_SESSION['name']=$name;
        echo "<div class=\"alert alert-success\" align=\"center\">Details updated Successfully</div>";
        echo "<script>toastr.success('Passwords Updated');</script>";
    }
 else {
      ...
      <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
              ...
              <li><a href="" style="font-size: 20;"><div class="glyphicon glyphicon-cog"></div>Settings</a></li>
      ...
      <div class="row">
        <div style="background-color: #333333" class="col-sm-3 col-md-2 sidebar" style="top:0;">
          <ul class="nav nav-sidebar">
              <li>
                 <img id="profile" class="img-rounded" src="<?php if($imgpath=='')  {echo "../images/default.png";} else   {echo $imgpath;}?>" style="border-radius: 200px;width:100%;height: auto; " onmouseover="display();" onmouseout="dontdisplay();">
              </li>
              <li class="active" style="font-size: 20;"><a href="profileStudent.php">Profile<span class="sr-only">(current)</span></a></li>
              <li style="font-size: 20;"><a href="" data-toggle="modal" data-target="#myModal1">Generate Provisional Marks Sheet</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <form action="" method="POST" id="settings_validate" enctype="multipart/form-data">
          ...
          <div class="table-responsive">
              ...
              <div class="modal-content">
                  <div class="modal-header" style="background-color: green">
                      <button type="button" class="close" data-dismiss="modal" style="color: white">&times;</button>
                      <h4 class="modal-title" align="center" style="color: white" ><div class="glyphicon glyphicon-lock"></div>&nbsp;&nbsp;Account Settings</h4>
                  </div>
                  <div class="modal-body">
