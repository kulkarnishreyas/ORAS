                ...
                <div class="body">
                    ...
                    $email='';
                        if(isset($_POST['edit_details']))   {
                            ...
                            $updateSQL="UPDATE teacher SET imgpath='$uploadImgpath', name='$name', password='$password', bdate='$bdate',
                            phno='$phno', address='$address', email='$email' where ssn='{$_POST['ssn1']}'";
                        ...
                        if(isset($_GET['u']))   {
                            if(!empty($_GET['u']))  {
                                ...
                                mysql_connect('localhost', 'root') and mysql_select_db('resultmanagement') or die();
                                $fetchSQL="select * from teacher where ssn='$usn'";
                    ...
                    <div class="col-md-6">USN:<input type="text" disabled name="usn" class="form-control" value="<?php echo $row['ssn']?>"></div></div>
                    ...
                    <div class="col-md-6"><br>E-mail:<br><input type="email" name="email" id="email" class="form-control"></div>
                    
                    <div class="col-md-12">
                        <hr>
                    <input type="submit" class="form-control btn btn-info" name="edit_details" value="Update" style="width: 20%">
                    <input type="hidden" name="ssn1" value="<?php echo $row['ssn']?>">
                    </div>
                    </form>
            </div>
