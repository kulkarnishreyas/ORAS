...
if(isset($_POST['edit_details'])){
    ...
    $updateDetailsSql="UPDATE `teacher` SET `name`='$name', `bdate`='$date', `phno`='$phno', `email`='$email', `address`='$address' where `usn`='$username'";
      ...
      <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
              <li><a href="profileTeacher.php" style="font-size: 20;"><div class="glyphicon glyphicon-home"></div>Dashboard</a></li>
              <li><a href="settingsTeacher.php" style="font-size: 20;"><div class="glyphicon glyphicon-cog"></div>Settings</a></li>
